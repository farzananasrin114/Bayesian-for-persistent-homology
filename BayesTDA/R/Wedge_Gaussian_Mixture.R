...
#' @usage Wedge_Gaussian_Mixture(weights, means, sigmas)
#' @name Wedge_Gaussian_Mixture
#' @param weights: a list of mixture weights
#' @param means: a list of two element vector, means of the restricted Gaussian
#' @param sigmas: a list of positive constants, sigmas in covariance matrices of the restricted Gaussian
